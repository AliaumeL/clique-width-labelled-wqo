...
undirected graphs. In this paper,  will use the following well-known fact.

\begin{fact}
  \label{fact:trees-bdcw-not-bdlcw}
  The class of complete binary \kl{trees} seen as graphs using the \kl{parent relation}
  is infinite and has \kl{bounded clique-width}. 
  However, any subset of this class 
  having \kl{bounded linear clique-width} must be finite.
\end{fact}
