...
\maelin{TODO: unify $(u,v)$ and $uv$)}
\maelin{Remarque globale : si tu dis qu'on ne parle que de graphe/arbre fini, alors pas besoin de repréciser fini à chaque fois.}
\paragraph*{Graphs} \AP
...
$u, v \in V$ \mael{, directed else ??}. In this paper we will focus on finite undirected graphs\mael{without self-loop ?}. Given a
...
\intro{antichain}. \maelin{an antichain is the same thing as bad sequence? How it is presented may be confusing.}
