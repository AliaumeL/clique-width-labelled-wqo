...
\AP If there is a bound $N_0$ on the \kl{dimension} of \kl{bad boughs}, we can
...
\begin{proof}
  ...
  than $N_0$, we replace it by a \kl{good bough} $H$ of level $k$ with
  dimension exactly $N_0$, which exists by assumption. This operation does not
