...
such as the sum and the product of WQOs. As an example, the fact that $X^*$
(finite words having elements of $X$ as letters) is a WQO whenever $X$ is a
WQO, also known as Higman's lemma \cite{HIG52}, has been used in the
...
From \cref{main:theorem}, we derive the following corollary that solves
