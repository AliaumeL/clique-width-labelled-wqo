...
$\ell \ V(G) \to X$. The induced subgraph relation is then extended to labelled
...
to this property as being \reintro(wqo){orderably} well-quasi-ordered.
...
classes \cite[Conjecture 4]{DRT10}. All the classes considered in \cite{DRT10}
...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    \item $\Cls$ is \kl{orderably well-quasi-ordered},
  \end{enumerate}
\end{theorem}
...
graphs, and MSO interpretations.
\cref{sec:ramseyan} shows how to reduce the study of graph classes obtained by
MSO interpretations from trees to the study of trees labelled over finite monoids.
We introduce forward Ramseyan splits and define marked nested trees, establishing
\cref{thm:marked-nested-trees-wqo} which proves that
bounded well-marked nested trees are well-quasi-ordered.
\cref{sec:bad-patterns} identifies combinatorial obstructions to being 
2-well-quasi-ordered in images of interpretations from trees. 
We develop the theory of boughs and their types, establishing key lemmas
about perfect and imperfect boughs.
\cref{sec:hereditary-classes} brings together the previous results to prove
our main theorems. We establish \cref{main:theorem} showing the equivalence
between 2-WQO, $\forall$-WQO, and orderably WQO for images of MSO interpretations
from trees, and \cref{main:corollary} extending this to hereditary classes of
bounded clique-width. We also prove \cref{thm:characterisations} which provides
multiple equivalent characterizations of when such classes are 2-well-quasi-ordered,
including via periodic antichains and existential transductions.
\cref{sec:conclusion} discusses open problems and future directions.
