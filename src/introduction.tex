...
conjectures, but were unable to generalise their results \cite[Conjecture
...
\begin{theorem}
  ...
  \begin{itemize}
    ...
    \item 
      The class $\Label{X}{\Cls}$ is well-quasi-ordered under the labelled induced subgraph relation,
    \item 
...
\begin{theorem}
  ...
  \begin{itemize}
    ...
    \item There exists a class $\Cls[D] \subseteq \Cls$
      and $\Cls[D]$ is of \kl{bounded linear clique-width} is not 
      \kl{$2$-well-quasi-ordered},
...
\begin{example}
  ...
  i.e., acyclic graphs where every vertex has degree at most $3$, and a single vertex has degree $2$.
