...
5.1]{Kuske06}). Fortunatelly, one usually considers \emph{labelled}
...
\begin{example}
  ...
  has bounded clique-width, is not \kl{$2$-well-quasi-ordered},
...
\begin{proof}
  ...
  by transducing all finite substructures, that in particular contains all finite
  ...
  complete binary trees have many more, and interpretations must preserve automorphisms.
\end{proof}
