...
These antichains appear in \cite[Conjecture 2]{ALM17}, that considers about
...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    \item There exists a class $\Cls[D] \subseteq \Cls$
      ...
      \kl{$2$-well-quasi-ordered},
    \item There exists a periodic sequence of graph forming an antichain in $\Cls$,
...
\begin{proof}[Proof Sketch]
  ...
  linear clique-width. Finally, because \kl{strong periodic antichains} have 
  bounded linear clique-width (see \cref{sec:interpreting-paths})
  there cannot be any \kl{strong periodic antichain} in $\Cls$.
  The \kl{existential transduction} of all finite paths from $\Cls$ is obtained
  by transducing all induced subgraphs (see \cref{ex:transducing-all-subgraphs}), 
