...
\begin{proof}[Proof Sketch]
  ...
  by triplicating $B$, that is, letting $H \defined B B B$, and mapping leaves 
...
\begin{proof}
  ...
  represents an \kl{imperfect bough} of \kl(bough){dimension} at most $N$.
...
\begin{proof}
  ...
  so is $H \defined BBB$. But this only depends on the \kl{bough types}
