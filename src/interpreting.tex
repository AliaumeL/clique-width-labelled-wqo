...
First, because of transduction, we can assume the class is hereditary. Hence,
if not 2WQO, we can even assume that the class is of bounded linear clique
width. Therefore, we are in the situation of having a single graph $G$ and
considering $G^N$ for arbitrarily large $N$. 
